...
namespace BasicESP
{
    public class Renderer : Overlay
    {
        ...
        private int selectedKey = 0x12; // LAlt по умолчанию
        private readonly Dictionary<string, int> keyOptions = new Dictionary<string, int>
        {
            { "Left Alt", 0x12 },
            { "Left Shift", 0xA0 },
            { "Left Ctrl", 0xA2 },
        ...
        public int SelectedKey => selectedKey;
        ...
        protected override void Render()
        {
            ...
            if (ImGui.BeginCombo("Trigger Key", keyOptions.First(k => k.Value == selectedKey).Key))
            {
                ...
                {
                    bool isSelected = (selectedKey == key.Value);
